...
cl = LineClient("boobyshah964@gmail.com","termux964")
cl.log("289d58d8dac0ec869834cc2bf072de22" + str(cl.authToken))
channel1 = LineChannel(cl,cl.server.CHANNEL_ID['LINE_TIMELINE'])
cl.log("Py8r9LsDUX3zmMZ61lsvB61scOfR6tNSxCgSc+Nw4AfgFfct2mfRRafDCTsj/i8kCaUw09iD58b5U6XNjC84HM4A4Z6AaotAfIzHMZSvB7ZR0bntWfcuxtt6Zmhq29tq50M4ydRzWRKxpKwrJXVbYAdB04t89/1O/w1cDnyilFU=" + str(channel1.channelAccessToken))


ki = LineClient("@gmail.com","password")
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))


kk = LineClient("@gmail.com","password")
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))


kc = LineClient("@gmail.com","password")
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))


kb = LineClient("@gmail.com","password")
kb.log("Auth Token : " + str(kb.authToken))
channel4 = LineChannel(kb)
kb.log("Channel Access Token : " + str(channel3.channelAccessToken))


kd = LineClient("@gmail.com","password")
kd.log("Auth Token : " + str(kd.authToken))
channel5 = LineChannel(kd)
kd.log("Channel Access Token : " + str(channel5.channelAccessToken))


sw = LineClient("@gmail.com","password")
...
poll = LinePoll(cl)
call = cl
creator = ["289d58d8dac0ec869834cc2bf072de22"]
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「 X-Men User Bot 」\n\n"+ma+"\nTotal「%s」List Bots" %(str(len(Bots))))
                          ...
                          if msg._from in admin:
                            ...
                            with requests.session() as s:
                                ...
                                try:
                                    ...
                                    cl.sendMessage(to, "Data cctv Not found!")
...
">>>BYEE-BYEE<..\nLU DENDAM GUE TUNGGU\n<<<<<<<<<>>\nhttp://line.me/ti/p/~gerhanaselatan\nhttp://line.me/ti/p/~cyber01")
                        ...
                        elif cmd == "inviteghost": #antijs stay
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = cl.getGroup(msg.to)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[Abi_Bots].")
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           kd.sendMessage(msg.to,"Added successfully admin")                                                                                                                                                       
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           kd.sendMessage(msg.to,"Added successfully staff")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           kd.sendMessage(msg.to,"Added successfully bot")
                                       except:
                                           pass
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           ...
                                           kd.sendMessage(msg.to,"Successfully deleted admin")
                                       except:
                                           pass
